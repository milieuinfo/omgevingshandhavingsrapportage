...
export class GewestelijkAnalyseView extends LitElement {
  ...
  <section is="vl-region">
      <div is="vl-layout">
          <div is="vl-grid">
              <div is="vl-column" id="content-1">
                  <h3 is="vl-h3">Een wegwijzer doorheen de cijfers en grafieken</h3>
                  <p>
                     Deze pagina toont een inzichtelijke beeld over de cijfers van gewestelijke handhavingsactoren.
                     De grafieken zijn volledig interactief en de cijfers zullen worden gewijzigd naargelang de gekozen filtering.
                      ...
                      <div is="vl-side-navigation-content">
                          <ul is="vl-side-navigation-group">
                              <li is="vl-side-navigation-item" data-vl-parent="content-1">
                                  ...
                                  <ul>
                                      <li is="vl-side-navigation-item">
                                          <div>
                                              <a href="#content-1-1" data-vl-parent="content-1">Toezichthouders</a>
                                          </div>
                                      </li>
                                      <li is="vl-side-navigation-item">
                                          <div>
                                      ...
                                      <li is="vl-side-navigation-item">
                                          <div>
                                              <a href="#content-1-5" data-vl-parent="content-1">Instrumentarium</a>
                                          </div>
                                      </li>
                                  </ul>
                              </li>
                              ...
                              <li is="vl-side-navigation-item" data-vl-parent="content-3">
                                  <a is="vl-side-navigation-toggle" href="/provinciaal">
                                      Provinciaal analyse
                                      <i class="vl-vi vl-vi-arrow-right-fat"></i>
                                  </a>
                              </li>
          ...
          <div is="vl-grid">
              ...
              <div is="vl-column" data-vl-size=4>
                  <vl-infoblock data-vl-title="Selectiebalk" data-vl-icon="cursor-finger-up">
                      Hierboven staan uw actieve selecties op de pagina en zullen de cijfers aangepast worden op basis van
                      de geselecteerde
                      gewestelijke handhavingsactor. Dit selectiebalk is interactief en u kunt selecties aanpassen of
                      toevoegen.
                  </vl-infoblock>
  
  
                  <vl-infoblock data-vl-title="Uw selectie mogelijkheden" data-vl-icon="cursor-finger-left">
                      In de filterpaneel staan de mogelijke selecties dat u kunt uitvoeren op de pagina.
                      U kunt meerdere gewestelijke handhavingsactoren aanduiden en de cijfers en grafieken zullen
                      aangepast worden
      ...
      <div is="vl-layout" class="vl-layout">
          ...
          <div is="vl-grid">
              <div is="vl-column" data-vl-size=8 class="data-top-bot">
                  <vl-infoblock data-vl-title="Gewestelijke toezichthouders en VTE" data-vl-icon="business-graph-bar">
                      In deze sectie worden de aantal gewestelijke toezichthouders aangegeven met de totaal aantal besteed
                      aan VTE.
                      De grafiek toont de verdeling aan van de VTE toezicthouders ten opzichte van de administratieve en
      ...
      <div is="vl-layout">
          <div is="vl-grid">
              <div is="vl-column" data-vl-size=8>
                  <vl-info-tile data-vl-auto-open=true>
                      <span slot="title">Verdeling van VTE toezichthouders en administratieve en juridische ondersteuning
                      </span>
                      <div slot="content">
  ...
  <section is="vl-region">
      <div is="vl-layout" class="vl-layout">
          <div is="vl-grid" id="content-1-2">
              <div is="vl-column" data-vl-size=8 class="data-top-bot">
                  <vl-infoblock data-vl-title="Klachten" data-vl-icon="business-graph-bar">
                      ...
                      In de grafiek wordt de verdeling van de totale hoeveelheid klachten onderverdeeld in de
          ...
          <div is="vl-grid">
              <div is="vl-column" data-vl-size=2>
          ...
          <div is="vl-grid">
              ...
              <div is="vl-column" data-vl-size=6>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Verdeling controles per categorie</span>
                      <div slot="content">
          ...
          <div is="vl-grid" id="content-1-4">
              <div is="vl-column" data-vl-size=8 class="data-top-bot">
                  <vl-infoblock data-vl-title="Aanvankelijke controles met overtreding" data-vl-icon="business-graph-bar">
          ...
          <div is="vl-grid" id="content-1-5">
              <div is="vl-column" data-vl-size=8 class="data-top-bot">
                  <vl-infoblock data-vl-title="Instrumentarium" data-vl-icon="business-graph-bar">
                      De instrumentarium is een verzameling van verschillende handelingen die worden uitgevoerd in kader
          ...
          <div is="vl-grid">
              ...
              <div is="vl-column" data-vl-size=4>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Bestuurlijk maatregel met dwangsom </span>
          ...
          <div is="vl-grid">
              ...
              <div is="vl-column" data-vl-size=4>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Bestuurlijk maatregel zonder dwangsom </span>
  ...
  <section is="vl-region">
      <div is="vl-layout" class="vl-layout">
          ...
          <div is="vl-grid">
              <div is="vl-column" data-vl-size=8 class="data-top-bot">
                  <vl-infoblock data-vl-title="Een overzicht voor ruimtelijke ordening" data-vl-icon="business-graph-bar">
                      Hieronder bevindt zich een overzicht van de cijfers voor de controles van de
                      omgevingshandhavingsrapportage.
                  </vl-infoblock>
              </div>
          ...
          <div is="vl-grid">
              <div is="vl-column" data-vl-size=2>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Klachten<span slot="subtitle"><img src="">
                          </span>
                      </span>
                      <div slot="content">
              ...
              <div is="vl-column" data-vl-size=2>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Controles<span slot="subtitle"><img src="">
                          </span>
                      </span>
                      <div slot="content">
              ...
              <div is="vl-column" data-vl-size=4>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Aanvankelijke controles met overtreding<span
          ...
          <div is="vl-grid">
              <div is="vl-column" data-vl-size=4>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Raadgeving<span slot="subtitle"><img src="">
                          </span>
                      </span>
                      <div slot="content">
              ...
              <div is="vl-column" data-vl-size=4>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Aanmaning<span slot="subtitle"><img src="">
                          </span>
                      </span>
                      <div slot="content">
          ...
          <div is="vl-grid">
              ...
              <div is="vl-column" data-vl-size=4>
                  <vl-info-tile data-vl-auto-open=true><span slot="title">Proces-verbaal<span slot="subtitle"><img src="">
                          </span>
                      </span>
                      <div slot="content">
    ...
    <div is="vl-grid">
            <div is="vl-column" data-vl-size=2>
                <vl-info-tile data-vl-auto-open=true><span slot="title">Veiligheidsmaatregel<span slot="subtitle"><img
                                src="">
                        </span>
                    </span>
                    <div slot="content">
                        <div class="RO-KPI-Veiligheidsmaatregel object"></div>
                    </div>
                </vl-info-tile>
            </div>
            <div is="vl-column" data-vl-size=2>
                <vl-info-tile data-vl-auto-open=true><span slot="title">Veiligheidsmaatregel<span slot="subtitle"><img
                    ...
                    <div slot="content">
                        <div class="RO-KPI-Veiligheidsmaatregel-percent object"></div>
                    </div>
                </vl-info-tile>
            </div>
            <div is="vl-column" data-vl-size=2>
  ...
  <section is="vl-region">
      <div is="vl-layout">
          <div is="vl-grid">
              <div is="vl-column" data-vl-size=8>
                  <h3 is="vl-h3">Ga naar de volgende analyse</h3>
