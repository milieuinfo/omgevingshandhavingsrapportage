          ...
          <div is="vl-layout">
            <div is="vl-grid" data-vl-is-stacked>
                ...
                <div is="vl-side-navigation-reference">
                  ...
                  <section id="content-1-2" is="vl-region">
                    <div is="vl-grid">
                      ...
                      ">
                      <vl-infoblock
                          data-vl-title="GAS-reglement - milieugerelateerde overlast "
              ...
              <div is="vl-grid">
                <div is="vl-column" data-vl-size=3 class="data-top-bot">
                  <vl-info-tile data-vl-auto-open=true>
                    <span slot="title">Klasse 1 - Inrichtingen<br/><span
                        class="hidden">.</span></span>
                    <div slot="content">
                ...
                <div is="vl-column" data-vl-size=3 class="data-top-bot">
                  <vl-info-tile data-vl-auto-open=true>
                    <span slot="title">Klasse 2 - Inrichtingen<br/><span
                        class="hidden">.</span></span>
                    <div slot="content">
          ...
          <div is="vl-grid">
            <div is="vl-column" data-vl-size=5>
              <vl-info-tile data-vl-auto-open=true>
                ...
                <span
                    slot="subtitle">Hover over de grafiek voor meer informatie</span>
                <div slot="content">
          ...
          <div is="vl-grid">
            ...
            <div is="vl-column" data-vl-size=12 class="data-top-bot">
              <vl-infoblock
                ...
                onderverdeeld in negen thematische categorieën. De
                overtredingsgraad wordt - indien de data gekend zijn - berekend
                aan de hand van de verhouding van het totaal aantal
                aanvankelijke controles met schending ten opzichte van het
                aantal aanvankelijke controles naar aanleiding van klachten en
                meldingen en het aantal aanvankelijke controles op eigen
                initiatief.
              </vl-infoblock>
            </div>
          </div>
        ...
        <section id="content-1-8" is="vl-region">
          ...
          <div is="vl-grid" class="data-top-bot">
            ...
            <div is="vl-column" data-vl-size=8>
              <vl-info-tile data-vl-auto-open=true>
                <span
                    slot="title">Onderverdeling verslag van vaststelling</span>
                <div slot="content">
                  ...
                  <div is="vl-grid">
                    <div is="vl-column" data-vl-size=6>
                      <vl-info-tile data-vl-auto-open=true>
                        ...
                        <div slot="content">
                          <div
                              class="GEM-bestuurlijkmaatregelmetGEM objectinstrumentarium">
                          </div>
                        </div>
                      </vl-info-tile>
                    </div>
                    <div is="vl-column" data-vl-size=6>
                      <vl-info-tile data-vl-auto-open=true>
                        ...
                        <div slot="content">
                          <div
                              class="GEM-bestuurlijkmaatregelzonderGEM objectinstrumentarium"></div>
                        </div>
                      </vl-info-tile>
                    </div>
                  </div>
              ...
              <ul is="vl-side-navigation-group">
                <li is="vl-side-navigation-item" data-vl-parent="content-1">
                  ...
                  <ul>
                    ...
                    <li is="vl-side-navigation-item">
                      <div>
                        <a href="#content-1-4" data-vl-parent="content-1">Lokale
                    ...
                    <li is="vl-side-navigation-item">
                      <div>
                        <a href="#content-1-7" data-vl-parent="content-1">Aanvankelijke
                    ...
                    <li is="vl-side-navigation-item">
                      <div>
                        <a href="#content-1-9" data-vl-parent="content-1">Opmerking
                          handhavingsactor</a>
                      </div>
                    </li>
                ...
                <li is="vl-side-navigation-item" data-vl-parent="content-3">
                  <a is="vl-side-navigation-toggle"
                     href="/public/gemeentendashboardro"
                     data-vl-child="content-4">
