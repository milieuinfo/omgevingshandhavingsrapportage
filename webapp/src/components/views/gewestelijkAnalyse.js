    ...
    return analysis({
      ...
      `
        <vl-functional-header data-vl-back="Terug"
                              data-vl-back-link="/public/gewestelijk"
                ...
                <div is="vl-side-navigation-reference">
                  <section id="content-1" is="vl-region">
                    ...
                    <p>
                      ...
                      handhavingsactiviteiten van de
                      ...
                      aan de hand van de selectiebalk
                      hieronder.
                    ...
                    <div is="vl-grid">
                      ...
                      <div is="vl-column">
                        <vl-infoblock data-vl-title="Selectiebalk"
                          ...
                          geselecteerde gewestelijke
                          handhavingsactoren.
                          Deze selectiebalk is interactief; er kunnen selecties
                          worden aangepast of
                          toegevoegd.
                        </vl-infoblock>
                        ...
                        <vl-infoblock data-vl-title="Uw selectie mogelijkheden"
                          ...
                          deze pagina. Er kunnen meerdere gewestelijke
                          handhavingsactoren aangeduid worden.
                  ...
                  <section id="content-1-2" is="vl-region">
                    ...
                    <div is="vl-grid">
                      ...
                      ">
                      <vl-infoblock
                          data-vl-title="Gewestelijke toezichthouders en VTE"
        ...
        <section id="content-1-3" is="vl-region">
          ...
          <div is="vl-grid">
            <vl-tooltip data-vl-placement=bottom>De som van de gegevens uit de
              verschillende categorieën
              kan verschillen van het totaal aantal aangezien niet alle actoren
              het totaal aantal
            ...
            <div is="vl-column" data-vl-size=12 class="data-top-bot">
              <vl-infoblock data-vl-title="Klachten"
                            data-vl-icon="business-graph-bar">
                De klachten voor milieu worden in de grafiek onderverdeeld in
                negen thematische
                categorieën.
              </vl-infoblock>
            </div>
          ...
          <div is="vl-grid">
            ...
            <div is="vl-column" data-vl-size=12 class="data-top-bot">
              <vl-infoblock data-vl-title="Controles"
                ...
                <br/>
                initiële en navolgende controles; en controles naar aanleiding
                van klachten en meldingen en controles op eigen initiatief.
              </vl-infoblock>
            </div>
          </div>
        ...
        <section id="content-1-5" is="vl-region">
          <div is="vl-grid">
            ...
            <div is="vl-column" data-vl-size=12 class="data-top-bot">
              <vl-infoblock
                  ...
                  data-vl-icon="business-graph-bar">
                De aanvankelijke controles met schending worden in de grafiek
                onderverdeeld in negen
                thematische categorieën. De overtredingsgraad wordt - indien de
                data gekend zijn -
                berekend aan de hand van de verhouding van het totaal aantal
                aanvankelijke controles
                met schending ten opzichte van het aantal aanvankelijke
                controles naar aanleiding
                van klachten en meldingen en het aantal aanvankelijke controles
                op eigen initiatief.
              </vl-infoblock>
            </div>
          </div>
          <div is="vl-grid">
            <div is="vl-column" data-vl-size=4>
              <vl-info-tile data-vl-auto-open=true>
                <span
                    slot="title">Aantal aanvankelijke controles met schending</span>
                <div slot="content">
                  ...
                  <div is="vl-grid">
                    <div is="vl-column" data-vl-size=6>
                      <vl-info-tile data-vl-auto-open=true>
                        ...
                        <div slot="content">
                          <div
                              class="MIL-KPI-Bestuurlijk-maatregel-met-dwangsom object">
                          </div>
                        </div>
                      </vl-info-tile>
                    </div>
        ...
        <section id="content-1-7" is="vl-region">
          ...
          <section is="vl-region">
            ...
            <div is="vl-grid" id="content-3-1">
              <div is="vl-column" data-vl-size=12 class="data-top-bot">
                <vl-infoblock
                    data-vl-title="Verbalisanten en stedenbouwkundige inspecteurs en VTE"
                    data-vl-icon="business-graph-bar">
                </vl-infoblock>
              </div>
            </div>
          ...
          <section id="content-3-3" is="vl-region">
            <div is="vl-grid">
              <vl-tooltip data-vl-placement=bottom>
                De som van de gegevens uit de verschillende categorieën kan
                verschillen van het
                totaal aantal aangezien niet alle actoren het totaal aantal
                kennen, maar wel
          ...
          <section id="content-3-4" is="vl-region">
            <div is="vl-grid">
              <div is="vl-column" data-vl-size=12 class="data-top-bot">
                <vl-infoblock
                    data-vl-title="Aantal aanvankelijke controles met schending"
                    data-vl-icon="business-graph-bar">
                  De overtredingsgraad wordt - indien de data gekend zijn -
                  berekend aan de hand
                  van de verhouding van het totaal aantal aanvankelijke
                  controles met schending
                  ten opzichte van het aantal aanvankelijke controles naar
                  aanleiding van klachten
                  en meldingen en het aantal aanvankelijke controles op eigen
                  initiatief.
                </vl-infoblock>
              </div>
            </div>
          ...
          <section id="content-3-6" is="vl-region">
            ...
            <section is="vl-region" id="content-4">
              ...
              <vl-alert>
                <p>
                  <a is="vl-link-button" href="/public/provinciaal">Per
                    provincie</a>
                  <a is="vl-link-button" href="/public/gemeenten">Per
                    gemeenten</a>
                    ...
                    <li>
                      ...
                      <ul>
                        <li><a
                            ...
                            download>Klik hier om de data te downloaden</a></li>
                      </ul>
                    </li>
                    <li>
                      Data van 2021
                  ...
                  <ul is="vl-side-navigation-group">
                    <li is="vl-side-navigation-item" data-vl-parent="content-1">
                      ...
                      <ul>
                        ...
                        <li is="vl-side-navigation-item">
                          <div>
                            <a href="#content-1-2" data-vl-parent="content-1">Toezichthouders
                              en VTE</a>
                          </div>
                        </li>
                        <li is="vl-side-navigation-item">
                    ...
                    <li is="vl-side-navigation-item" data-vl-parent="content-3">
                      <a is="vl-side-navigation-toggle" href="#content-3"
                      ...
                      <ul>
                        <li is="vl-side-navigation-item">
                          <div>
                            <a href="#content-3-1" data-vl-parent="content-3">Verbalisanten
                              en
                        ...
                        <li is="vl-side-navigation-item">
                          <div>
                            <a href="#content-3-4" data-vl-parent="content-3">Aanvankelijke
                              controles met schending</a>
                          </div>
                        </li>
                    </li>
                    <li is="vl-side-navigation-item">
                    ...
                    <li is="vl-side-navigation-item">
                      <div>
                        <a href="#content-3-6" data-vl-parent="content-3">Opmerking
                          handhavingsactor</a>
                      </div>
                    </li>
