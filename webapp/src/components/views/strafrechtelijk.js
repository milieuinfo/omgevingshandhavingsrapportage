              ...
              <div is="vl-column" data-vl-size="8" data-vl-medium-size="8"
                ...
                <div is="vl-side-navigation-reference">
                  <section id="content-1" is="vl-region">
                    <h3 is="vl-h3">Strafrechtelijke en bestuurlijke
                      vervolgtraject</h3>
                    <h4 is="vl-h4">Over de cijfers en procedure</h3>
                      ...
                      <vl-typography>
                        ...
                        <ul>
                          <li>Het proces-verbaal dat werd opgemaakt bij de
                            vaststelling van een misdrijf en dat
                            wordt overgemaakt aan de parketten bij de
                            rechtbanken van eerste aanleg met het oog
                            op een strafrechtelijke afhandeling.
                          </li>
                          <li>
                            het verslag van vaststelling dat werd opgemaakt bij
                            de vaststelling van een inbreuk en
                            dat wordt overgemaakt aan de gewestelijke
                            beboetingsentiteit met het oog op een
                            bestuurlijke afhandeling.
                          </li>
                        </ul>
                        <p>Rudimentaire schematische voorstelling van deze
                          trajecten:</p>
                      </vl-typography>
                      <br>
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg"
                           ...
                           version="1.1" width="831px" height="401px"
                           viewBox="-0.5 -0.5 831 401"
                        ...
                        <defs/>
                        <g>
                          <path d="M 120 40 L 393.63 40" fill="none"
                                stroke="rgb(0, 0, 0)" stroke-miterlimit="10"
                                pointer-events="stroke"/>
                          <path
                              d="M 398.88 40 L 391.88 43.5 L 393.63 40 L 391.88 36.5 Z"
                              fill="rgb(0, 0, 0)" stroke="rgb(0, 0, 0)"
                              stroke-miterlimit="10" pointer-events="all"/>
                          <rect x="0" y="10" width="120" height="60"
                                fill="#d86623" stroke="none"
                                pointer-events="all"/>
                          <g transform="translate(-0.5 -0.5)">
                            <switch>
                              <foreignObject pointer-events="none" width="100%"
                                             height="100%"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div
                                    ...
                                    <div
                                      ...
                                      <font
                                          color="#ffffff">Proces-verbaal</font>
                                    </div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="60" y="44" fill="rgb(0, 0, 0)"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">Proces-verbaal
                              </text>
                            </switch>
                          </g>
                          <rect x="400" y="0" width="160" height="80"
                                fill="#6e8c2b" stroke="none"
                                pointer-events="all"/>
                          <g transform="translate(-0.5 -0.5)">
                            <switch>
                              <foreignObject pointer-events="none" width="100%"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div
                                    ...
                                    <div
                                        style="display: inline-block; font-size: 12px; font-family: Helvetica; color: rgb(0, 0, 0); line-height: 1.2; pointer-events: all; white-space: normal; overflow-wrap: normal;">
                                      <font color="#ffffff">Parketten bij de
                                        rechtbanken van eerste aanleg</font>
                                    </div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="480" y="44" fill="rgb(0, 0, 0)"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">Parketten bij de
                                rechtbank...
                              </text>
                            </switch>
                          </g>
                          <path d="M 120 200 L 393.63 200" fill="none"
                                stroke="rgb(0, 0, 0)" stroke-miterlimit="10"
                                pointer-events="stroke"/>
                          <path
                              d="M 398.88 200 L 391.88 203.5 L 393.63 200 L 391.88 196.5 Z"
                              fill="rgb(0, 0, 0)" stroke="rgb(0, 0, 0)"
                              stroke-miterlimit="10" pointer-events="all"/>
                          <rect x="0" y="170" width="120" height="60"
                                fill="#d86623" stroke="none"
                                pointer-events="all"/>
                          <g transform="translate(-0.5 -0.5)">
                            <switch>
                              <foreignObject pointer-events="none" width="100%"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div
                                    ...
                                    <div
                                        style="display: inline-block; font-size: 12px; font-family: Helvetica; color: rgb(0, 0, 0); line-height: 1.2; pointer-events: all; white-space: normal; overflow-wrap: normal;">
                                      <font color="#ffffff">Verslag van
                                        vaststelling</font></div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="60" y="204" fill="rgb(0, 0, 0)"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">Verslag van vaststel...
                              </text>
                            </switch>
                          </g>
                          <rect x="400" y="160" width="160" height="80"
                                fill="#6e8c2b" stroke="none"
                                pointer-events="all"/>
                          <g transform="translate(-0.5 -0.5)">
                            <switch>
                              <foreignObject pointer-events="none" width="100%"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div
                                    ...
                                    <div
                                        style="display: inline-block; font-size: 12px; font-family: Helvetica; color: rgb(0, 0, 0); line-height: 1.2; pointer-events: all; white-space: normal; overflow-wrap: normal;">
                                      <font color="#ffffff">Gewestelijke
                                        beboetingsentiteit (GBE)</font></div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="480" y="204" fill="rgb(0, 0, 0)"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">Gewestelijke
                                beboetingsent...
                              </text>
                            </switch>
                          </g>
                          <rect x="400" y="320" width="160" height="80"
                                fill="#6e8c2b" stroke="none"
                                pointer-events="all"/>
                          <g transform="translate(-0.5 -0.5)">
                            <switch>
                              <foreignObject pointer-events="none" width="100%"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div
                                    ...
                                    <div
                                        style="display: inline-block; font-size: 12px; font-family: Helvetica; color: rgb(0, 0, 0); line-height: 1.2; pointer-events: all; white-space: normal; overflow-wrap: normal;">
                                      <font color="#ffffff">Handhavingscollege
                                        (HHC)</font></div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="480" y="364" fill="rgb(0, 0, 0)"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">Handhavingscollege
                                (HHC)
                              </text>
                            </switch>
                          </g>
                          <rect x="125" y="10" width="260" height="30"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div data-drawio-colors="color: #FFFFFF; "
                                    ...
                                    <div
                                      ...
                                      <font color="#000000">door handhaver
                                        overgemaakt aan het parket <br/>met oog
                                        op strafrechtelijke
                                        afhandeling<br/></font></div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="255" y="29" fill="#FFFFFF"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">door handhaver
                                overgemaakt aan het parket...
                              </text>
                            </switch>
                          </g>
                          <rect x="135" y="170" width="240" height="30"
                                fill="none" stroke="none" pointer-events="all"/>
                          <g transform="translate(-0.5 -0.5)">
                            <switch>
                              <foreignObject pointer-events="none" width="100%"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div data-drawio-colors="color: #000000; "
                                    ...
                                    <div
                                      ...
                                      door handhaver overgemaakt aan de GBE<br/>met
                                      oog op bestuurlijke afhandeling
                                    </div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="255" y="189" fill="#000000"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">door handhaver
                          ...
                          <path d="M 560 80 L 560 153.63" fill="none"
                                stroke="rgb(0, 0, 0)" stroke-miterlimit="10"
                                pointer-events="stroke"/>
                          <path
                              d="M 560 158.88 L 556.5 151.88 L 560 153.63 L 563.5 151.88 Z"
                              fill="rgb(0, 0, 0)" stroke="rgb(0, 0, 0)"
                              stroke-miterlimit="10" pointer-events="all"/>
                          <rect x="560" y="80" width="250" height="80"
                                fill="none" stroke="none" pointer-events="all"/>
                          <g transform="translate(-0.5 -0.5)">
                            <switch>
                              <foreignObject pointer-events="none" width="100%"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div data-drawio-colors="color: #FFFFFF; "
                                    ...
                                    <div
                                        style="display: inline-block; font-size: 12px; font-family: Helvetica; color: rgb(255, 255, 255); line-height: 1.2; pointer-events: all; white-space: nowrap;">
                                      <font color="#000000">Het parket kan (al
                                        het dit niet zelf wenst te <br/>behandelen)
                                        een proces-verbaal overmaken<br/>aan GBE
                                        met het oog op het opleggen van<br/>een
                                        alternatieve bestuurlijke geldboete<br/><br/></font>
                                    </div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="685" y="124" fill="#FFFFFF"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">Het parket kan (al het
                                dit niet zelf wens...
                              </text>
                            </switch>
                          </g>
                          <rect x="560" y="255" width="270" height="50"
                                fill="none" stroke="none" pointer-events="all"/>
                          <g transform="translate(-0.5 -0.5)">
                            <switch>
                              <foreignObject pointer-events="none" width="100%"
                                ...
                                <div xmlns="http://www.w3.org/1999/xhtml"
                                  ...
                                  <div data-drawio-colors="color: #FFFFFF; "
                                    ...
                                    <div
                                        style="display: inline-block; font-size: 12px; font-family: Helvetica; color: rgb(255, 255, 255); line-height: 1.2; pointer-events: all; white-space: nowrap;">
                                      <font color="#000000">Als de GBE een
                                        alternatieve of exclusieve <br/>bestuurlijke
                                        geldboete heeft opgelegd, kan hier <br/>tegen
                                        in beroep worden gegaan bij het HHC<br/></font>
                                    </div>
                                  </div>
                                </div>
                              </foreignObject>
                              <text x="695" y="284" fill="#FFFFFF"
                                    font-family="Helvetica" font-size="12px"
                                    text-anchor="middle">Als de GBE een
                                alternatieve of exclusieve...
                              </text>
                            </switch>
                          </g>
                          <path d="M 559 240 L 559 313.63" fill="none"
                                stroke="rgb(0, 0, 0)" stroke-miterlimit="10"
                                pointer-events="stroke"/>
                          <path
                              d="M 559 318.88 L 555.5 311.88 L 559 313.63 L 562.5 311.88 Z"
                              fill="rgb(0, 0, 0)" stroke="rgb(0, 0, 0)"
                              stroke-miterlimit="10" pointer-events="all"/>
                        </g>
                        <switch>
                          ...
                          <a transform="translate(0,-5)"
                             ...
                             target="_blank">
                            <text text-anchor="middle" font-size="10px" x="50%"
                                  y="100%">Text is not SVG - cannot display
                            </text>
                          </a></switch>
                      </svg>
                  </section>
                    ...
                    <div is="vl-grid">
                      <div is="vl-column">
                        <div style="max-width: 400px" id="content-2"
                             class="data-top-bot">
                          <a is="vl-doormat"
                             href="/public/strafrechtelijkAnalyse">
                            <h2 is="vl-doormat-title">Analyseer de cijfers</h2>
                            <div is="vl-doormat-text">
                              Bekijk de cijfers inzake het strafrechtelijke en
                              bestuurlijke vervolgtraject.
                            </div>
                          </a>
                        </div>
                      </div>
                    ...
                    <ul is="vl-side-navigation-group">
                      <li is="vl-side-navigation-item"
                        ...
                        <ul>
                          <li is="vl-side-navigation-item">
                            <div>
                              <a href="#content-1" data-vl-parent="content-1">Over
                                cijfers en
                                procedure</a>
                            </div>
                          </li>
                          <li is="vl-side-navigation-item">
                            <div>
                              <a href="#content-1-2" data-vl-parent="content-1">Analyseer
                                de cijfers</a>
                            </div>
                          </li>
                        </ul>
