    ...
    return analysis({
      ...
      `
        <vl-functional-header data-vl-back="Terug"
                              data-vl-back-link="/public/strafrechtelijk"
                ...
                <div is="vl-side-navigation-reference">
                  <section id="content-1" is="vl-region">
                    <h2 is="vl-h2">Een wegwijzer doorheen de cijfers en
                      grafieken</h2>
                    <p>
                      Deze pagina toont een beeld van het strafrechtelijke en
                      bestuurlijke vervolgtraject van de instrumenten
                      proces-verbaal en verslag van vaststelling. De grafieken
                      zijn interactief en de cijfers zullen wijzigen naargelang
                      de gekozen filtering.
                  ...
                  <section id="content-1-1" is="vl-region">
                    ...
                    <vl-infoblock data-vl-icon="business-graph-bar">
                      ...
                      Hieronder kan een bestand worden gedownload met duiding
                      bij de statistische bijdrage van het Openbaar Ministerie:
                      ...
                      <p>
                        <span slot="title"><a
                            ...
                            download>Duiding bij de statistische bijdrage</a></span>
                      </p>
                    </vl-infoblock>
                    <hr>
                    <div is="vl-grid" class="data-top-bot">
                      ...
                      <div is="vl-column" data-vl-size=12>
                        <my-instroom id="selectiebalk"></my-instroom>
                      </div>
                    ...
                    <p><span class="ondertitel">Selecteer een thema voor gedetailleerdere informatie</span>
                    </p>
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=12>
                        <vl-typography>
                          <h5>Afhandeling zonder strafvervolging om
                            opportuniteitsredenen</h5></vl-typography>
                      </div>
                    </div>
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=12>
                        <vl-typography>
                          <h5>Afhandeling zonder strafvervolging om technische
                            redenen</h5></vl-typography>
                      </div>
                    </div>
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12>
                  ...
                  <section id="content-1-2" is="vl-region">
                    ...
                    <vl-infoblock data-vl-icon="business-graph-bar">
                      ...
                      Voor informatie over de gewestelijke beboetingsentiteit
                      kan u navigeren naar
                      <vl-document>
                        <span slot="type">URL</span>
                        <span slot="title"><a
                            href="https://navigator.emis.vito.be/mijn-navigator?woId=39023">Naar regelgeving</a></span>
                      </vl-document>
                    </vl-infoblock>
                    <hr>
                    </vl-infoblock>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=12>
                        <vl-typography>
                          <h5>Milieu</h5>
                          <p>Klik op een staafbalk voor een verdere
                            opsplitsing.</p>
                        </vl-typography>
                        <div is="vl-column" data-vl-push=8>
                          <a is="vl-link-button" href="#selectiebalk">Terug naar
                            selectiebalk</a>
                        </div>
                      </div>
                    </div>
                  ...
                  <section id="content-1-3" is="vl-region">
                    <hr>
                    <vl-infoblock data-vl-icon="business-graph-bar">
                      <h2 slot="title">Handhavingscollege – beroepen tav
                        bestuurlijke geldboeten</h2>
                      Voor informatie over het Handhavingscollege kan u
                      navigeren naar
                      <vl-document>
                        <span slot="type">URL</span>
                        <span slot="title"><a
                            href="https://navigator.emis.vito.be/mijn-navigator?woId=22487"
                            target="_blank">Naar regelgeving</a></span>
                      </vl-document>
                    </vl-infoblock>
                    <hr>
                    <div is="vl-grid" class="data-top-bot">
                  ...
                  <section is="vl-region" id="content-4">
                    ...
                    <vl-alert data-vl-title="Cijfers andere handhavingsactoren"
                              data-vl-type="info">
                      <p>
                        <a is="vl-link-button" href="/public/gewestelijk">per
                          gewest</a>
