...
render() {
    return analysis({
      children: html`
        <vl-functional-header data-vl-back="Terug"
                              data-vl-back-link="/public/gemeenten"
            ...
            <div is="vl-grid" data-vl-is-stacked>
              <div is="vl-column" data-vl-size="8" data-vl-medium-size="8"
                ...
                <div is="vl-side-navigation-reference">
                  <section is="vl-region">
                    <h2 is="vl-h2">Een wegwijzer doorheen de cijfers en
                      grafieken</h2>
                    <p>
                      Deze pagina toont een overzichtelijk beeld van de
                      handhavingsactiviteiten van de gemeenten.
                      De grafieken zijn interactief en de cijfers zullen
                      wijzigen naargelang de gekozen filtering.
                      De gekozen filtering kan op elk moment worden verwijderd
                      aan de hand van de selectiebalk hieronder.
                  ...
                  <section id="content-1" is="vl-region">
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12>
                        <vl-infoblock data-vl-title="Selectiebalk"
                                      data-vl-icon="cursor-finger-up">
                          Hierboven staan de actieve selecties op deze pagina.
                          De cijfers worden aangepast op basis van de
                          geselecteerde gemeeenten. Deze selectiebalk is
                          interactief; er kunnen selecties worden aangepast of
                          toegevoegd.
                        </vl-infoblock>
                        <vl-infoblock data-vl-title="Uw selectie mogelijkheden"
                                      data-vl-icon="cursor-finger-down">
                          In het filterpaneel staan de mogelijke selecties die
                          kunnen worden uitgevoerd op deze pagina. Er kunnen
                          meerdere provincies aangeduid worden.
                          De cijfers en grafieken zullen worden aangepast op
                          basis van de selecties.
                        </vl-infoblock>
                      </div>
                    </div>
                    <br/>
                  ...
                  <section>
                    <vl-infoblock data-vl-title="Organisatie lokale handhaving"
                                  data-vl-icon="business-graph-bar"></vl-infoblock>
                  </section>
                  ...
                  <section>
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=6 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          <span slot="title">Naam <br/>gemeente<br/><span
                    ...
                    <div is="vl-grid" data-vl-v-stretch>
                      ...
                      <div is="vl-column" data-vl-size=3 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          <span slot="title">Lokale politie<br/><span
                              class="hidden">.<br/>.</span></span>
                          <div slot="content">
                      ...
                      <div is="vl-column" data-vl-size=3 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          <span slot="title">Andere gemeente<br/><span
                              class="hidden">.<br/>.</span></span>
                          <div slot="content">
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size="12">
                        <vl-typography>
                          <h4>Handhaving ruimtelijke ordening (RO)
                            <h4>
                              <hr/>
                        </vl-typography>
                      </div>
                    ...
                    <div is="vl-grid" data-vl-v-stretch>
                      ...
                      <div is="vl-column" data-vl-size=3 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          <span
                              slot="title">Intergemeentelijk samenwerkings-<br/>verband</span>
                          <div slot="content">
                  ...
                  <section id="content-1-1" is="vl-region">
                    ...
                    <div is="vl-grid" id="content-1-1">
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-infoblock
                            data-vl-title="Verbalisanten en stedenbouwkundige inspecteurs"
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true>
                                      <span slot="title">Verbalisanten<span
                                          slot="subtitle">
                                          </span></span>
                          <div slot="content">
                            <img class="icon"
                      ...
                      <div is="vl-column" data-vl-size=8>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            ...
                            <div
                                class="GEM-PIE-Verbalitisanten chartTabelsm"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                    </div>
                    <div is="vl-grid" class="data-top-bot">
                      ...
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true>
                              <span
                                  slot="title">Stedenbouwkundige inspecteurs<span
                                  slot="subtitle">
                                      </span></span>
                          <div slot="content">
                        ...
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-natuurlijke persoon.png">
                            <div
                                class="GEM-stedenbouwkundigeinspec objectinstrumentarium"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                      <div is="vl-column" data-vl-size=8>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            ...
                            <div
                                class="GEM-PIE-StedenBKVerb chartTabelsm"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                    </div>
                  ...
                  <section id="content-1-2" is="vl-region">
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-infoblock data-vl-title="Totaal VTE"
                                      data-vl-icon="business-graph-bar">
                        </vl-infoblock>
                      </div>
                    </div>
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Totaal VTE<span
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-trainer_B.png">
                  ...
                  <section id="content-1-3" is="vl-region">
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Aantal klachten<span
                            slot="subtitle">
                                          </span>
                                      </span>
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-Meld_verdachte_handelingen.png">
                      ...
                      <div is="vl-column" data-vl-size=8>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <div
                                class="Gem-Onderverdeling-klachten chartTabelsm"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                    </div>
                  ...
                  <section id="content-1-4" is="vl-region">
                    <div is="vl-grid">
                      <vl-tooltip data-vl-placement=bottom>De som van de
                        gegevens uit de verschillende categorieën
                        kan verschillen van het totaal aantal aangezien niet
                        alle actoren het totaal aantal
                        kennen, maar wel gegevens aanleveren in de categorieën.
                      </vl-tooltip>
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-infoblock data-vl-title="Controles"
                                      data-vl-icon="business-graph-bar">
                          De controles worden in de grafiek onderverdeeld in
                          categorieën:
                          <br/>
                          initiële en navolgende controles; en controles naar
                          aanleiding van klachten en meldingen en controles op
                          eigen initiatief.
                        </vl-infoblock>
                      </div>
                    </div>
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Aantal controles<span
                            slot="subtitle">
                                  </span>
                              </span>
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-onderzoek.png">
                    ...
                    <div is="vl-grid">
                      ...
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <div
                                class="Gem-Onderverdeling-controles chartTabelsm"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                  ...
                  <section id="content-1-5" is="vl-region">
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-infoblock
                            data-vl-title="Aanvankelijke controles met schending"
                            data-vl-icon="business-graph-bar">
                          De overtredingsgraad wordt - indien de data gekend
                          zijn - berekend aan de hand van de verhouding van het
                          totaal aantal aanvankelijke controles met schending
                          ten opzichte van het aantal aanvankelijke controles
                          naar aanleiding van klachten en meldingen en het
                          aantal aanvankelijke controles op eigen initiatief.
                        </vl-infoblock>
                      </div>
                    </div>
                    ...
                    <div is="vl-grid">
                      ...
                      <div is="vl-column" data-vl-size=6>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Overtredingsgraad<span
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-barometer.png">
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=12>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Onderverdeling aanvankelijke controles met schending<span
                            slot="subtitle">
                              </span>
                          </span>
                          <div slot="content">
                            ...
                            <div
                                class="Gem-Onderverdeling-aacontroles chartTabelsm"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                  ...
                  <section id="content-1-6" is="vl-region">
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-infoblock data-vl-title="Instrumentarium"
                                      data-vl-icon="business-graph-bar">
                        </vl-infoblock>
                      </div>
                    </div>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-Informatie.png">
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-Kalender.png">
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-klipbord.png">
                            <div
                                class="Gem-ro-inst-verslagvaststelling object"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                      <div is="vl-column" data-vl-size=8>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      ...
                      <div is="vl-column" data-vl-size=8>
                        <vl-info-tile data-vl-auto-open=true>
                          <span
                              slot="title">Onderverdeling proces-verbaal</span>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-time-out.png">
                            <div
                                class="Gem-ro-inst-beveltotstaking object"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                      <div is="vl-column" data-vl-size=8>
                        <vl-info-tile data-vl-auto-open=true>
                          <span
                              slot="title">Onderverdeling bevel tot staking</span>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=12>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-risicoanalyse.png">
                            ...
                            <div is="vl-grid">
                              <div is="vl-column" data-vl-size=6>
                                <vl-info-tile data-vl-auto-open=true>
                                  ...
                                  <div slot="content">
                                    <div
                                        class="Gem-ro-bestm-kpi-mdw objectinstrumentarium">
                                    </div>
                                  </div>
                                </vl-info-tile>
                              </div>
                              <div is="vl-column" data-vl-size=6>
                                <vl-info-tile data-vl-auto-open=true>
                                  ...
                                  <div slot="content">
                                    <div
                                        class="Gem-ro-bestm-kpi-zwd objectinstrumentarium"></div>
                                  </div>
                                </vl-info-tile>
                              </div>
                            </div>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Afgesloten minnelijke schikking</span>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-overeenkomst.png">
                            <div
                                class="Gem-ro-inst-afgeslotenminschik object"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                      <div is="vl-column" data-vl-size=8>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Herstelvordering</span>
                          <span
                              slot="subtitle">Ingeleid bij Openbaar ministerie</span>
                          <div slot="content">
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Herstelvordering</span>
                          <span
                              slot="subtitle">Gevorderd bij Burgelijke rechter</span>
                          <div slot="content">
                            <img class="icon" src="assets/icons/PNG-EHBO.png">
                      ...
                      <div is="vl-column" data-vl-size=8>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Onderverdeling herstelvordering</span>
                          ...
                          <div slot="content">
                            ...
                            <div
                                class="Gem-ro-onder-burgelijkrechter chart"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                    </div>
                    ...
                    <div is="vl-grid" class="data-top-bot">
                      <div is="vl-column" data-vl-size=4>
                        <vl-info-tile data-vl-auto-open=true><span slot="title">Ambtshalve uitvoering gerechtelijke herstelvordering</span>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-justitie.png">
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <div
                                class="Gem-ro-opmerking-gem chartTabelsm"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                    </div>
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <div
                                class="Gem-ro-opmerking-igs chartTabelsm"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                    </div>
                  ...
                  <section is="vl-region" id="content-4">
                    ...
                    <vl-alert data-vl-icon="info-circle"
                              data-vl-title="Bekijk de cijfers van andere thema's"
                              data-vl-type="info">
                      <p>
                        <a is="vl-link-button"
                           href="/public/gewestelijk">Gewest</a>
                        <a is="vl-link-button" href="/public/provinciaal">Provinciaal</a>
                        <a is="vl-link-button" href="/public/hogeraad">Hoge
                          raad</a>
                        <a is="vl-link-button" href="/public/strafrechtelijk">Strafrechtelijk
                          en bestuurlijk
                          vervolgtraject</a>
                      </p>
                    </vl-alert>
                    ...
                    <ul is="vl-side-navigation-group">
                      <li is="vl-side-navigation-item"
                        ...
                        <ul>
                          <li is="vl-side-navigation-item">
                            <div>
                              <a href="#content-1-1" data-vl-parent="content-1">Verbalitisanten
                                en
                          ...
                          <li is="vl-side-navigation-item">
                            <div>
                              <a href="#content-1-5" data-vl-parent="content-1">Aanvankelijke
                                controles met overtreding</a>
                            </div>
                          </li>
                          <li is="vl-side-navigation-item">
                            <div>
                          ...
                          <li is="vl-side-navigation-item">
                            <div>
                              <a href="#content-1-7" data-vl-parent="content-1">Opmerking
                                handhavingsactor</a>
                            </div>
                          </li>
                      ...
                      <li is="vl-side-navigation-item"
                          data-vl-parent="content-2">
                        <a is="vl-side-navigation-toggle" href="#content-2"
                      ...
                      <li is="vl-side-navigation-item"
                          data-vl-parent="content-3">
                        <a is="vl-side-navigation-toggle"
                           href="/public/gemeentendashboard"
                           data-vl-child="content-4">
