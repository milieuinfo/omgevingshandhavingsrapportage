    ...
    return analysis({
      children: html`
        <vl-functional-header data-vl-back="Terug"
                              data-vl-back-link="/public/provinciaal"
                              data-vl-title="Cijfers van provinciale handhavingsactoren"
                              data-vl-sub-title="Een analyse van de provinciale handhavingsactoren"
                              data-vl-link="Provinciale handhavingsactoren">
                ...
                <div is="vl-side-navigation-reference">
                  <section id="content-1" is="vl-region">
                    ...
                    <p>
                      ...
                      handhavingsactiviteiten van de provinciale
                      handhavingsactoren.
                      ...
                      Als de gegevens niet gekend zijn, verschijnt - of wordt
                      aangegeven dat de data niet beschikbaar zijn.
                    </p>
                    <br>
                    ...
                    <div is="vl-grid">
                      ...
                      <div is="vl-column" data-vl-size=8>
                        <vl-infoblock data-vl-title="Selectiebalk"
                          ...
                          geselecteerde provincie(s). Deze selectiebalk is
                  ...
                  <section id="content-1-1" is="vl-region">
                    <div is="vl-grid">
                      ...
                      <p><a is="vl-link"
                            ...
                            target="_blank">Bekijk de bevoegheden van de
                        provincies</a></p>
                    </div>
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-infoblock data-vl-title="Provinciegouverneur"
                    ...
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12>
                        <vl-alert
                            ...
                            data-vl-type="info"
                        >
                          <p>Voor het analysejaar 2022 werden er geen
                            bestuurlijke maatregelen noch veiligheidsmaatregelen
                            gerapporteerd.</p>
                        </vl-alert>
                      </div>
                    </div>
                  ...
                  <section id="content-1-2" is="vl-region">
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-infoblock
                            data-vl-title="Provinciale toezichthouders en VTE"
                            data-vl-icon="business-graph-bar">
                        </vl-infoblock>
                      </div>
                    </div>
                  ...
                  <section id="content-1-3" is="vl-region">
                    <div is="vl-grid">
                      ...
                      >De som van de gegevens uit de verschillende categorieën
                        kan verschillen van het totaal aantal aangezien niet
                        alle actoren het totaal aantal kennen, maar wel gegevens
                        aanleveren in de categorieën.
                      </vl-tooltip
                      >
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        ...
                        <vl-infoblock data-vl-title="Klachten"
                                      data-vl-icon="business-graph-bar">
                          De klachten voor milieu worden in de grafiek
                          onderverdeeld in negen thematische categorieën.
                    ...
                    <div is="vl-grid">
                      ...
                      <div is="vl-column" data-vl-size=8 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          <span
                              slot="title">Aantal klachten per categorie</span>
                          <div slot="content">
                  ...
                  <section id="content-1-4" is="vl-region">
                    ...
                    <div is="vl-grid">
                      ...
                      <div is="vl-column" data-vl-size=8 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          <span
                              slot="title">Aantal controles per categorie</span>
                          <div slot="content">
                    ...
                    <div is="vl-grid">
                      ...
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <vl-infoblock
                            ...
                            data-vl-icon="business-graph-bar">
                          De aanvankelijke controles met schending worden in de
                          grafiek onderverdeeld in negen thematische
                          categorieën. De overtredingsgraad wordt - indien de
                          data gekend zijn - berekend aan de hand van de
                          verhouding van het totaal aanvankelijke controles met
                          overtreding ten opzichte van het aantal aanvankelijke
                          controles naar aanleiding van klachten en meldingen en
                          het aantal aanvankelijke controles op eigen
                          initiatief.
                        </vl-infoblock>
                      </div>
                    </div>
                      ...
                      <div is="vl-column" data-vl-size=4 class="data-top-bot">
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            ...
                            <div
                                class="Aanvankelijkecontrolesmetovertreding object"></div>
                          </div>
                        </vl-info-tile>
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            ...
                            <div
                                class="PROV-KPI-Overtredingsgraad object"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                        ...
                        <vl-info-tile data-vl-auto-open=true>
                          ...
                          <div slot="content">
                            <img class="icon"
                                 src="assets/icons/PNG-klipbord.png">
                            <div
                                class="PROV-KPI-verslagvanvastelling object"></div>
                          </div>
                        </vl-info-tile>
                      </div>
                      <div is="vl-column" data-vl-size=6 class="data-top-bot">
                      ...
                      <div is="vl-column" data-vl-size=12>
                        <div is="vl-grid">
                          <div is="vl-column" data-vl-size=12>
                            ...
                            >
                              <p>Voor het analysejaar 2022 werden er geen
                                bestuurlijke maatregelen gerapporteerd.</p>
                            </vl-alert>
                          </div>
                        </div>
                      ...
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                        <div is="vl-grid">
                          <div is="vl-column" data-vl-size=12>
                            ...
                            >
                              <p>Voor het analysejaar 2022 werden er geen
                                veiligheidsmaatregelen gerapporteerd.</p>
                            </vl-alert>
                          </div>
                        </div>
                      </div>
                  ...
                  <section id="content-1-7" is="vl-region">
                    <div is="vl-grid">
                      <div is="vl-column" data-vl-size=12>
                        <vl-infoblock
                            data-vl-title="Opmerking handhavingsactoren"
                            data-vl-icon="business-graph-bar">
                        </vl-infoblock>
                      </div>
                      <div is="vl-column" data-vl-size=12 class="data-top-bot">
                    ...
                    <ul is="vl-side-navigation-group">
                      <li is="vl-side-navigation-item"
                        ...
                        <ul>
                          ...
                          <li is="vl-side-navigation-item">
                            <div>
                              <a href="#content-1-2" data-vl-parent="content-1">Provinciale
                                toezichthouders en VTE</a>
                            </div>
                          </li>
                          <li is="vl-side-navigation-item">
                            <div>
