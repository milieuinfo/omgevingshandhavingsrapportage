              ...
              >
                <div is="vl-side-navigation-reference">
                  <section id="content-1" is="vl-region">
                    <h2 is="vl-h2">Strafrechtelijk en bestuurlijk
                      vervolgtraject</h2>
                  </section>
                    ...
                    <vl-typography>
                      ...
                      <ul>
                        <li>Het proces-verbaal dat werd opgemaakt bij de
                          vaststelling van een misdrijf en dat wordt overgemaakt
                          aan de parketten bij de rechtebanken van eerste aanleg
                          met het oog op een strafrechtelijke afhandeling
                        </li>
                        <li>
                          het verslag van vastelling dat werd opgemaakt bij de
                          vastelling van een inbreuk en dat wordt overgemaakt
                          aan de gewestelijke beboetingsentiteit met het oog op
                          een bestuurlijke afhandeling.
                        </li>
                      </ul>
                      <p>Rudimentaire schematische voorstelling van deze
                        trajecten:</p></vl-typography>
                    <br>
                  ...
                  <section id="content-2" is="vl-region">
                    ...
                    <vl-infoblock data-vl-icon="data-download">
                      ...
                      Hieronder kan u de bestand downloaden in PDF formaat van
                      de duiding van strafrechtelijk
                      <vl-document
                          data-vl-href="documents/Duiding bij de statistische bijdrage van het Openbaar Ministerie.pdf">
                        <span slot="type">PDF</span>
                        <span
                            slot="title">Duiding bij de statische bijdrage</span>
                    ...
                    <div is="vl-grid">
                      ...
                      <div is="vl-column" data-vl-size="12"
                           data-vl-medium-size="6">
                        <p>Instroom - herkomst</p>
                        <div class="TabelVooruitgangs chart"></div>
                      </div>
                      <div is="vl-column" data-vl-size="12"
                           data-vl-medium-size="6">
                        <p>Instroom - herkomst</p>
                        <div class="TabelSeponering chart"></div>
                      </div>
                  ...
                  <section id="content-3" is="vl-region">
                    <vl-infoblock data-vl-icon="data-download">
                      <h2 slot="title">Gewestelijke beboetingsentiteit en
                      ...
                      <ul
                        ...
                        <li is="vl-link-list-item">
                          <a is="vl-link"
                             href="https://navigator.emis.vito.be/mijn-navigator?woId=39023">
                            Ga naar gewestelijke beboetingsentiteit -
                            bestuurlijke geldboeten</a>
                        </li>
                      </ul>
                    </vl-infoblock>
                  </section>
                  ...
                  <section id="content-4" is="vl-region">
                    <h3 is="vl-h3">Handhavingscollege - beroepen tav
                      bestuurlijke geldboeten</h3>
