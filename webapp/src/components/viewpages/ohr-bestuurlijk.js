...
class OhrBestuurlijk extends LitElement {
  static get styles() {
  ...
  __renderSideNavigation() {
    return html`
    <a is="vl-link-button" href="/bestuurlijk-analyse">Bekijk de cijfers voor dit thema</a><br><br>
      ...
      <li is="vl-link-list-item">
       ...
       <li is="vl-link-list-item">
        <a target="_new_blank" is="vl-link"
          ...
          Website handhavingscollege<span is="vl-icon" data-vl-before="" data-vl-link="" data-vl-icon="external"></span>
        </a>
      </li>
    </ul>`;
  }
...
customElements.define("ohr-bestuurlijk", OhrBestuurlijk);
