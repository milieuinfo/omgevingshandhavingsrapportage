...
class OhrOpkaart extends LitElement {
  ...
  __renderDropdownOptions() {
    const options = ['Select One', 'Iframe 1', 'Iframe 2', 'Iframe 3',
      'Iframe 4', 'Iframe 5', 'Iframe 6', 'Iframe 7', 'Iframe 8', 'Iframe 9',
      'Iframe 10', 'Iframe 11', 'Iframe 12', 'Iframe 13', 'Iframe 14',
      'Iframe 15', 'Iframe 16', 'Iframe 17', 'Iframe 18', 'Iframe 19',
      'Iframe 20', 'Iframe 21', 'Iframe 22', 'Iframe 23'];
