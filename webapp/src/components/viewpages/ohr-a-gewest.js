...
class OhrAGewest extends LitElement {
    ...
    return html` <vl-functional-header
      ...
      <section is="vl-region">
        <div is="vl-layout">
          <vl-typography>
            <h2 is="vl-h2">
              Cijfers van het jaar ${this.yearofanalysis}
            </h2></vl-typography
          >
          ...
          <p is="vl-introduction" data-cy="introduction">
            ...
            <br />Via de filter kan u een gewestelijke omgevingshandhavingsactor
            kiezen.
          </p>
          <br />
  ...
  __renderDataSectionOpmerking(data, type) {
    return html`
      <table is="vl-data-table">
        <caption>
          ${type}
  ...
  __renderViewSelector() {
    return html`
      <vl-typography
        ><b>
          Kies uit de keuzelijst een gewestelijke handhavingsactor:</b
        ></vl-typography
      >
      <select
        id="viewselector"
      ...
      if (gegevensselectie === 0) {
        return html` <div is="vl-column" data-vl-size="12">
          <vl-alert
            ...
            data-vl-title="Geen cijfers beschikbaar"
            data-vl-type="warning"
            data-vl-message="De geselecteerde actor kon geen beroep doen op een gewestelijke toezichthouder."
          ></vl-alert>
        </div>`;
      } else if (beleid === "Both") {
        return html` <div is="vl-column" data-vl-size="6">
